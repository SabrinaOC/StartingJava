...
public class Ejercicio11_eliminar_fila_matriz_elegida_usuario {
	...
	public static void main(String[] args) {
		...
		String str = JOptionPane.showInputDialog("Introduzca un n�mero entre 0 y " + (matriz.length-1)); // Pedimos n�mero a
		// usuario
		int num = Integer.parseInt(str);
		
		do {
		str = JOptionPane.showInputDialog("Valor no admitido. Por favor, introduzca un n�mero entre 0 y " + (matriz.length-1)); // Pedimos n�mero a
		// usuario
