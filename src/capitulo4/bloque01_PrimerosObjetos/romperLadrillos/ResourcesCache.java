...
public class ResourcesCache {
	...
	public static String IMAGEN_NAVE = "nave-50x15.png";
	//public static String IMAGEN_PELOTA = "balon.jpg";
	...
	private String nombreCarpetaParaFile = "./src/capitulo4/bloque01_PrimerosObjetos/romperLadrillos/res/";
	...
	private void cargarFicheroEnHashMap(String nombreFichero) {
		...
		// Discriminará el caso de que intento cargar un sonido del caso de cargar
		// imágenes
		try {
