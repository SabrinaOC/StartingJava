...
public class Arkanoid {
	...
	public static void main(String[] args) {
		...
		// Lanzamos juego, bucle infinito que terminará cuando el jugador cierre la
		// ventana
	...
	public void jugar() {
		...
		do {
			...
			// para lograrlo, tenemos que calcular cuantos milisegundos tarda canvas en
			// repintarse
			...
			// Tras pintar actores en pantalla, detectamos colisiones y actualizamos la
			// lista de actores
			detectaColisiones();

			actualizaActores();
			// Volvemos a calcular milis para luego hacer una resta y calcular tiempo de
			// ejecución
	...
	private void detectaColisiones() {
		for (Actor actor1 : this.actores) {
			// Creamos un rectángulo para este actor tomando sus medidas y posición como
			// base
			...
			for (Actor actor2 : this.actores) {
				// Evitamos comparar un actor consigo mismo, ya que eso siempre provocaría una
				...
				if (!actor1.equals(actor2)) {
					...
					// Si los dos rectángulos tienen alguna intersección, notificamos una colisión
					// en los dos actores
